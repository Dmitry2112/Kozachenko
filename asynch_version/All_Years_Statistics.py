...
class AllYearsStatistics:
    ...
    @staticmethod
    def merge_statistics(array_of_year_stat_objects: [OneYearStatisticsInfo], full_file_name: str):
        """
        ...
        """
        towns_statistics_amount_dic, towns_statistics_salary_dic = AllYearsStatistics.get_statistics_by_cities(full_file_name)
        dic_year_amount = {}
        dic_year_salary = {}
        vac_year_amount = {}
        vac_year_salary = {}
